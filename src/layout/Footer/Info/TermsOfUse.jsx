...
const TermsOfUser = () => {
  return (
    <Wrap>
      ...
      <h3>제1조 (목적)</h3>
      <InnerText>이 약관은 주식회사 인슈로 (이하" 회사"라 한다)가 운영하는 모바일기기를 통해 제공하는 모바일 서비스(이하 "서비스")를 이용함에 있어 서비스를 이용하는 이용자의 권리 · 의무 및 책임 사항을 규정함을 목적으로 합니다. 다만, 전자금융거래 이용에 관한 사항은 '전자금융거래 이용약관'의 내용을 따릅니다.</InnerText>
      <h3>제2조 (용어의 정의)</h3>
      <OlList className='numb'>
      ...
      <ListTitle>제2장 이용자 가입(이용)계약</ListTitle>
      <h3>제5조 (이용계약의 성립)</h3>
      <OlList className="numb">
      ...
      <ListTitle>제3장 서비스 제공 및 이용</ListTitle>
      ...
      <h3>제11조 (서비스의 개시/이용/중지)</h3>
        ...
        <ListTitle>제4장 서비스와 관련한 권리 · 의무 관계</ListTitle>
        <h3>제14조 (회사의 의무)</h3>
        <OlList className="numb">
        ...
        <InnerText>회사는 서비스의 게시물 또는 내용물이 회원이 회원의 의무에 위배되는 행위를 한 경우나 회사 소정의 게시기간을 초과하는 경우 및 게시판의 성격에 부합되지 않는 게시물인 경우 해당한다고 판단되는 경우 회원에게 사전통지나 동의 없이 이를 삭제할 수 있습니다.</InnerText>
        <ListTitle>제5장 기타</ListTitle>
        ...
        <h3>제20조 (손해배상)</h3>
        <InnerText>회사가 제공하는 서비스와 관련하여 회원에게 어떠한 손해가 발생하더라도 동 손해가 회사의 중대한 과실에 의한 경우를 제외하고는 회사는 이에 대하여 책임을 부담하지 않습니다.</InnerText>
        <h3>제21조 (책임한계)</h3>
        <OlList className="numb">
